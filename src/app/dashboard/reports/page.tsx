    ...
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500">Analisis dan unduh rekapitulasi penjualan proker Anda (KF-19).</p>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <p className="font-bold text-slate-900 text-sm">Paket Nasi Ayam Geprek</p>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                <p className="font-bold text-slate-900 text-sm">Es Teh Manis Jumbo</p>
                <div className="w-full bg-slate-100 h-2 rounded-full mt-2">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6 text-center py-16">
        ...
        <h3 className="text-lg font-bold text-slate-900 mb-2">Grafik Penjualan Bulanan</h3>
        <p className="text-slate-500 max-w-md mx-auto">Visualisasi data akan aktif setelah sistem memiliki minimal 30 hari data transaksi historis.</p>
      </div>
    </div>
  );
}
