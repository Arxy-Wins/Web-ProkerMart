  ...
  const roles = [
    {
      ...
      description: "Mahasiswa, dosen, atau staf yang ingin mencari dan membeli produk dari berbagai program kerja kampus.",
      icon: User,
    ...
    },
    {
      ...
      description: "Pengelola Sub-Toko. Mengatur produk, memproses pesanan masuk, dan melihat laporan penjualan proker sendiri.",
      icon: Store,
      color: "from-emerald-500 to-teal-500",
      bgColor: "bg-emerald-50",
      textColor: "text-emerald-600",
      features: ["Kelola Stok Barang", "Konfirmasi Pesanan", "Dashboard Proker"],
      link: "/dashboard",
    ...
    },
    {
      ...
      description: "BEM/HIMA/UKM pengelola Toko Induk. Mendaftarkan proker dan memantau total omzet seluruh kepanitiaan.",
      icon: Building2,
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-slate-600">
            Sistem ProkerMart memisahkan hak akses dan antarmuka berdasarkan peran pengguna sesuai dengan dokumen SKPL. Silakan pilih peran di bawah ini untuk melihat perbedaannya.
          </p>
        </div>
          ...
          {roles.map((role, i) => {
            ...
            return (
              ...
              >
                ...
                <div className="mb-8">
                  <h3 className="text-sm font-bold text-slate-900 mb-3 uppercase tracking-wider">Akses Utama:</h3>
